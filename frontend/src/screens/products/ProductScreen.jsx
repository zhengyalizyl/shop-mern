...
export default function ProductScreen() {
  ...
  const { loading: productReviewCreateLoading, error: productReviewCreateError, success: productReviewCreateSuccess } = useSelector(state => state.productReviewCreate);
  ...
  useEffect(() => {
    ...
    if (!product._id || productReviewCreateSuccess || product._id !== id ) {
      dispatch(getProduct(id))
      dispatch({ type: PRODUCT_CREATE_REVIEW_RESET })
    }
  
  }, [id, dispatch,productReviewCreateSuccess]);
